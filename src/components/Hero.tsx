...
function Hero() {
  return (
    <div className="bg-intro z-0 h-screen overflow-hidden bg-VeryLightGray sm:pb-16">
      <div className="mx-auto lg:flex lg:items-center lg:justify-between lg:pl-8 xl:max-w-[1440px]">
        <img src={heroImage} className="mx-auto -mt-16 grid lg:hidden" />
        ...
        <img
          src={heroImage}
          className="xl:-mr-50 -mt-10 hidden lg:-mr-32 lg:block lg:w-[44rem]"
        />
      </div>
    </div>
  );
